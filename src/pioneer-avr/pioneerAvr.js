...
var PioneerAvr = /** @class */ (function () {
    function PioneerAvr(api, log, host, port, maxVolumeSet, minVolumeSet, service, characteristic, pioneerAvrClassCallback) {
        var _this = this;
        this.api = api;
        this.log = log;
        this.host = host;
        ...
        initialize_1.initializePioneerAvr.call(this);
